              ...
              >
                ...
                <div className="p-8">
                  <p className="text-lg leading-relaxed text-[#AE1E23] italic">
                    ...
                    tailor your technology solution to meet critical Army capabilities gaps. Use our expertise to
                    enhance your solutions to Army and Department of Defense customers.
                  </p>
                </div>
              </motion.section>
            )}
        ...
        >
          ...
          <div className="p-8 text-center">
            <p className="text-lg leading-relaxed mb-6 indent-8 italic text-[#AE1E23]">
              ...
              Our insider's perspective on Army Aviation programs is based upon our first-hand experience in the
              cockpit.
            </p>
